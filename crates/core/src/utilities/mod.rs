...
pub use logging::{
    ...
    init_logging, init_logging_in, init_logging_with_filter, plugin_log_dir, PLUGIN_LOG_SUBDIR,
};
...
pub mod proxy;
pub use proxy::{
    apply_default_proxied_plugins, apply_proxy_to_client, effective_plugin_proxy_map,
    resolve_proxy_config, DEFAULT_PROXIED_PLUGINS,
};
