...
pub(crate) struct TrustedPluginRoot {
...
impl TrustedPluginRoot {
    ...
    pub(crate) fn revalidate_current_path(&self) -> Result<()> {
...
impl PluginLoader {
    ...
    pub fn load_plugin(&self, discovered: &DiscoveredPlugin) -> Result<LoadedPlugin> {
        ...
        let loaded = self
            .runtime
            .load_module_from_bytes(discovered.manifest.plugin.id.clone(), &wasm_bytes)?;
