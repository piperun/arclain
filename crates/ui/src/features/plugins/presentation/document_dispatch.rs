...
/// lets any facade-rendered surface navigate without coupling the
/// application session registry to egui's page stack.
///
...
/// this function does not know about cannot leak a session.
